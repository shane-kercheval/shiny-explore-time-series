    ...
    navbarPage(title = 'Explore Dataset',
                        ...
                        selectInput(width='750px',
                                    inputId='preloaded_dataset',
                                          ...
                                          choices=c("Anti-Diabetic Drug Sales in Australia from 1991 to 2008",
                                                    ...
                                                    "Total annual air passengers (millions) including domestic and international passengers of air carriers registered in Australia. 1970-2016.",
        ...
        tabPanel(
            ...
            column(3,
                ...
                bsCollapse(id='var_plots__bscollapse', open=c("Filter", "Options"), multiple=TRUE,
                    bsCollapsePanel(
                        "Filter",
                    ...
                    bsCollapsePanel(
                        "Options",
                        uiOutput('var_plots__date_zoom_slider__UI'),
                        bsTooltip(id='var_plots__date_zoom_slider__UI',
                                  title="This control does not filter out data.",
                                  placement='bottom', trigger='hover'),
                    ...
                    bsCollapsePanel(
                        ...
                        numericInput(inputId='var_plots__baseline__forecast_horizon',
                                     ...
                                     value=NULL),
                        numericInput(inputId='var_plots__baseline__ignore_n_periods',
                                     label="Ignore Last N Periods",
                                     value=NULL),
                        ...
                        bsTooltip(id='var_plots__baseline__biasadj',
                                  ...
                                  placement='bottom', trigger='hover'),
                        tags$div(class='bold_checkbox_input',
                                 checkboxInput(inputId='var_plots__baseline__damped',
                                               label="Damped Trend",
                                               value=FALSE)
                        ),
                        bsTooltip(id='var_plots__baseline__damped',
                                  title="Use a damped trend. Only available for certain models (e.g. ETS).",
                                  placement='bottom', trigger='hover'),
                        tags$div(class='bold_checkbox_input',
            ...
            column(3,
                ...
                bsCollapse(id='regression__collapse_controls', open=c("Variables", "Options"), multiple=TRUE,
                    ...
                    bsCollapsePanel(
                        ...
                        sliderTextInput(inputId='regression__tslm_lambda',
                                                    label="Lambda (tslm() parameter)",
                                                    choices=c("None", "Auto", seq(0, 1, 0.10)),
                                                    selected="None",
                                                    grid=TRUE),
                        numericInput(inputId='regression__ignore_last_x_periods',
                                     label="Ignore Last N Periods",
                                     value=NULL),
                        bsTooltip(id='regression__tslm_lambda',
                                  title="Applies Box-Cox transformation internally and back-transforms forecast values.",
                                  placement='bottom', trigger='hover'),
                    ...
                    tabPanel("Diagnostic Plots",
                        ...
                        tabsetPanel(type="tabs",
                            ...
                            tabPanel("Check Residuals",
                                ...
                                tags$h4("Breush-Godfrey Test For Serial Correlation"),
                                verbatimTextOutput(outputId='regression__diagnostic_breush_godfrey_test')
                            ),
